...
* 🌱 Learning more about **system design, backend performance, and deployment**
* 🎯 Goal: build impactful projects & grow as a professional software engineer

---

![Profile Views](https://komarev.com/ghpvc/?username=Akazelll\&color=111111\&style=flat)
...
AI-powered agriculture assistant that helps identify plant diseases and provides solutions using machine learning.

* Tech: Python, TensorFlow, Flask, Computer Vision
* Focus: ML inference, preprocessing, deployment-ready API
  🔗 [https://github.com/Akazelll/AgriSmart](https://github.com/Akazelll/AgriSmart)

### 📚 Digital Library

A web-based digital library system for managing and accessing books efficiently.

* Tech: Laravel, MySQL, Bootstrap
* Focus: CRUD system, authentication, clean MVC architecture
  🔗 [https://github.com/Akazelll/DigitalLibrary](https://github.com/Akazelll/DigitalLibrary)

### 📝 Bookletku

A simple and practical platform for creating and managing digital booklets.

* Tech: Next.js, Node.js, TailwindCSS
* Focus: modern UI, full-stack workflow, productivity tools
  🔗 [https://github.com/Akazelll/Bookletku](https://github.com/Akazelll/Bookletku)
...
I enjoy optimizing small details—because great software is built from thoughtful decisions.

📩 *Open for collaboration, learning, and new opportunities.*
